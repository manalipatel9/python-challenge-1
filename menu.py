...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection=input("Enter item number: ")
            ...
            if menu_selection.isdigit():
                ...
                if item_number in menu_items.keys():
                    ...
                    item_price=menu_items[items_number]["Price"]
                    ...
                    if item_quantity.isdigit():
                        ...
                        item_quantity=1
                        print(f"Item quanitity defaulted to 1")
...
for i in range(len(order_list)):
    ...
    print(list_item_name + item_spaces+list_price+price_spaces+list_quantity+quantity_spaces
